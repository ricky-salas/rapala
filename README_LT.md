...
Naujausias locked workflow: **DRAFT → SWAP OPEN → SWAP CLOSED / R.S. oversight → FINAL administracijai**.

R.S. visą mėnesio tvirtinimą valdo `Grafikas → Grafiko tvirtinimas`. Atidarius apsikeitimų langą realūs SMTP laiškai su tiksliu terminu siunčiami visiems rezidentams; pavėlavusiam rezidentui R.S. gali suteikti individualią ribotą late-swap prieigą. FINAL snapshotas ir FINAL backup planas užšaldomi, o administracijai atsisiunčiamas aiškiai pažymėtas FINAL Excel.

Žr. `V2_5_91_COLORED_FINALIZATION_WORKFLOW_NOTES.md` ir `EMAIL_SMTP_SETUP_V2_5_91.md`.
