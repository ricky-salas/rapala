...
## Superseded in V2.5.92
The V2.5.91 cohort-email wording and rigid multi-stage finalization flow are superseded by V2.5.92. V2.5.92 uses professional email wording and the simplified operator-controlled lifecycle documented in `V2_5_92_OPERATOR_FINALIZATION_NOTES.md`.
