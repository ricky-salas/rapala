...
with tabs[pos]:
    ...
    if lang=="LT":
        st.info(
            ...
            f"Struktūrinis guardrail: SPS RO / SPS UG / savaitgaliai raw 0–1; Onko ≤2 poromis; VISI kiti postai pirmiausia raw 0–1. 0–2/0–3 leidžiama tik įrodžius, kad siauresnis variantas neįmanomas + post debt. "
        ...
        st.info(
            ...
            f"Structural guardrail: SPS RO / SPS UG / weekends raw 0–1; Onko ≤2 in even pairs; ALL other posts first target raw 0–1. 0–2/0–3 is allowed only after the tighter corridor is proven infeasible + post debt. "
